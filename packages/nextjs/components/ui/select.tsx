...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ref={ref}
    className={cn("flex cursor-default text-mtext items-center justify-center py-1 font-base", className)}
    {...props}
  >
    <ChevronDown className="h-4 w-4" />
  </SelectPrimitive.ScrollDownButton>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("border-2 border-transparent py-1.5 pl-8 pr-2 text-sm font-base text-mtext/80", className)}
    {...props}
  />
));
