      ...
      <div className="flex-grow w-full px-2 sm:px-8 py-6 sm:py-12 bg-background">
        <div className="flex w-full justify-center items-center gap-6 sm:gap-12 flex-col">
          <div className="w-full max-w-[95%] sm:max-w-[75%] relative  [&_a]:text-green-800 [&_a]:underline [&_a:hover]:text-green-800/70">
            <h1 className="text-4xl sm:text-5xl font-bold text-center mb-2 sm:mb-4">
              The Bark Ruffalo Ecosystem Roadmap
            </h1>
            <div className="text-base sm:text-lg text-center mb-8 text-muted-foreground">
              Updated: May 13, 2025
            </div>
              ...
              <CardContent className="p-4 sm:p-8 relative">
                ...
                <div className="relative z-10">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base">
                    <li>marketing through AI agents on social media</li>
                    <li>income generation through platform fees, collaborations, strategic short-term investments, etc., while ultimately focusing on what proved to be the most effective</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4 sm:p-8 relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6 text-sm sm:text-base">
                    <div>
                      <div className="font-semibold text-base sm:text-lg mb-2">MARKETING:</div>
                      <ul className="pl-4 space-y-2">
                        <li><span className="text-lg mr-2">🎯</span>have at least 5 different AI agents running 24/7 on social media (start them after Eliza 2 reaches the main branch with a decent release); we&apos;ll use the previously gained experience to make them successful</li>
                      </ul>
                    </div>
                    <div>
                      <div className="font-semibold text-base sm:text-lg mb-2">NEW PLATFORMS:</div>
                      <ul className="pl-4 space-y-2">
                        <li><span className="text-lg mr-2">🎯</span><a href="https://scanner.trulyadog.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/90 underline">Scanner (web app)</a> should support at least two launchpads that are different than Virtuals Protocol, and open-source contributions should be attracted.</li>
                        <li><span className="text-lg mr-2">🎯</span><a href="https://t.me/cadogai/1084/16464" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/90 underline">Launchpad</a> (contracts + web app)</li>
                        <li><span className="text-lg mr-2">🎯</span><a href="https://x.com/TrulyADog/status/1887901312567697596" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/90 underline">Crypto ETF</a> (contracts + web app)</li>
                        <li><span className="text-lg mr-2">🎯</span>Language learning (web app + iOS/Android app) - subscription-based income</li>
                        <li><span className="text-lg mr-2">🎯</span>Cognitive improvement (web app + iOS/Android app) - subscription-based income</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-center mb-6 sm:mb-8 mt-12">
              The Path to Multi-Agentic Dominance (old roadmap)
            </h2>
