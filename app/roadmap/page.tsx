          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-wrap justify-center gap-4">
              <button
                ...
                className={`px-4 py-3 sm:px-8 sm:py-4 rounded-xl text-xs sm:text-sm font-medium transition-all duration-300 border border-transparent backdrop-blur-sm ${
                  activePhase === "1"
            ...
            {isPhase2Expanded && (
              <div className="flex flex-wrap justify-center gap-4 mt-3">
                <button
                  ...
                  className={`group relative px-4 py-2 sm:px-6 sm:py-3 rounded-xl text-xs font-medium transition-all duration-300 overflow-hidden ${
                    activePhase === "2a"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
            <div className="px-6 py-4 sm:px-8 sm:py-6 border-b border-gray-100 dark:border-gray-700">
              <div className="flex flex-col gap-4">
                <div>
                  <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white">{phases[activePhase].title}</h2>
